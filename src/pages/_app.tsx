...
const config = createConfig(
  getDefaultConfig({
    ...
    transports: {
      ...
      [polygonMumbai.id]: http( // Replace this line with the correct function call or value
      `https://polygon-mumbai.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ALCHEMY_MUMBAI}`,
      ),
    },
